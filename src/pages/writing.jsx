    ...
    return (
      <body className='writing'>
        ...
        I&apos;ve publshed&nbsp;
          ...
          , and won{' '}
          <a href="https://brownmotionpictures.org/" target="_blank" rel="noreferrer">
          ...
          ) if you&apos;d like other examples of my academic, professional, or fictional
            pieces.
        </div>  
        <div className='contactPhoto'> <img src="https://i.imgur.com/DDQ7Gc3.png"></img></div>
      </body>
    );
}
